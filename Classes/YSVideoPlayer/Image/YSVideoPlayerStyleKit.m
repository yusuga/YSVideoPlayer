...
//  YSVideoPlayer
//
//  Created by Yu Sugawara on 2016/05/29.
...
+ (void)drawPlay
{
    ...
    [arrow37iconPath moveToPoint: CGPointMake(32, 15)];
    [arrow37iconPath addLineToPoint: CGPointMake(9, 29)];
    [arrow37iconPath addLineToPoint: CGPointMake(9, 1)];
    [arrow37iconPath addLineToPoint: CGPointMake(32, 15)];
    [arrow37iconPath closePath];
    arrow37iconPath.miterLimit = 4;

    arrow37iconPath.lineJoinStyle = kCGLineJoinRound;

    [UIColor.blackColor setFill];
    [arrow37iconPath fill];
    [UIColor.blackColor setStroke];
    arrow37iconPath.lineWidth = 1.5;
    [arrow37iconPath stroke];
}
...
+ (void)drawPause
{
    ...
    [pauseiconPath moveToPoint: CGPointMake(11.06, 25)];
    [pauseiconPath addLineToPoint: CGPointMake(5, 25)];
    [pauseiconPath addLineToPoint: CGPointMake(5, 1)];
    [pauseiconPath addLineToPoint: CGPointMake(11.06, 1)];
    [pauseiconPath addLineToPoint: CGPointMake(11.06, 25)];
    [pauseiconPath closePath];
    [pauseiconPath moveToPoint: CGPointMake(21, 1)];
    [pauseiconPath addLineToPoint: CGPointMake(14.94, 1)];
    [pauseiconPath addLineToPoint: CGPointMake(14.94, 25)];
    [pauseiconPath addLineToPoint: CGPointMake(21, 25)];
    [pauseiconPath addLineToPoint: CGPointMake(21, 1)];
    [pauseiconPath closePath];
    pauseiconPath.miterLimit = 4;

    pauseiconPath.lineJoinStyle = kCGLineJoinRound;

    [UIColor.blackColor setFill];
    [pauseiconPath fill];
    [UIColor.blackColor setStroke];
    pauseiconPath.lineWidth = 1.5;
    [pauseiconPath stroke];
}
...
+ (void)drawReplay
{
    ...
    CGContextTranslateCTM(context, 2.5, 2.5);
    ...
    [bezierPath moveToPoint: CGPointMake(13, 3)];
    [bezierPath addLineToPoint: CGPointMake(13, 12)];
    [bezierPath addLineToPoint: CGPointMake(21, 7.5)];
    [bezierPath addLineToPoint: CGPointMake(13, 3)];
...
+ (UIImage*)imageOfReplay
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(28, 32), NO, 0.0f);
